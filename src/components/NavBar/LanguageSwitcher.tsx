...
export default function LanguageSwitcher(): JSX.Element {
  ...
  return (
    <section className="select-none z-50 flex flex-col items-end">
      <span
        onClick={toggleDropdown}
        className={`p-1 px-2 font-thin text-sm cursor-pointer ${
          dropdownOpen
      ...
      {dropdownOpen && (
        <div className="items-start flex flex-col gap-2 w-fit text-gray-600 text-sm h-fit p-4 bg-gray-200 absolute top-14">
          <div>
            <select
          ...
          <div
            onClick={onSubmit}
            className="bg-gold-primary w-fit h-fit rounded-sm text-ivory py-1 px-3 text-sm"
          >
            {t("submit")}
            {" >"}
          </div>
